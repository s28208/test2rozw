    ...
    public partial class Init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Title", x => x.IdTitle);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AcquiredId = table.Column<DateOnly>(type: "date", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.InsertData(
                ...
                columns: new[] { "CharacterId", "TitleId", "AcquiredId" },
                values: new object[,]
                {
                    { 1, 1, new DateOnly(2024, 5, 28) },
                    { 2, 1, new DateOnly(2024, 5, 31) },
                    { 3, 2, new DateOnly(2023, 6, 1) }
                });
